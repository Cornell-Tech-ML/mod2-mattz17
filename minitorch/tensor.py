...
class Tensor:
    ...
    def __eq__(self, t1: Tensor) -> Tensor:
    ...
    def mean(self, dim: Optional[int] = None) -> Tensor:
        ...
        if dim is None:
            ...
            reduce_size = self.shape[dim]
            return sum_result / reduce_size

    def permute(self, *dims: Union[int, Tuple[int, ...]]) -> Tensor:
        ...
        order_tensor = tensor(list(dims), backend=self.backend)
